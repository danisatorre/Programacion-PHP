    ...
    <form autocomplete="on" method="post" name="add_product" id="add_product"> 
        ...
        <table border='0'>
            <tr>
                ...
                <td><input type="text" id="nom_prod" name="nom_prod" placeholder="nombre" value=""/></td>
                <td><font color="red">
            ...
            <tr>
                <td>Descripcion: </td>
                <td><textarea rows="7" cols="57" id="descripcion" name="descripcion" placeholder="descripción" value=""></textarea></td>
                <td><font color="red">
